...
public class AutoListView extends ListView implements OnScrollListener {
	...
	private void initView(Context context) {
		...
		footer = inflater.inflate(R.layout.dialog_hy_pay_orderlist_footer, null);
		loadFull = (TextView) footer.findViewById(R.id.loadFull);
		noData = (TextView) footer.findViewById(R.id.noData);
		more = (TextView) footer.findViewById(R.id.more);
		loading = (ProgressBar) footer.findViewById(R.id.loading);

		header = inflater.inflate(R.layout.dialog_hy_refresh_header, null);
	...
	public void onRefreshComplete(String updateTime) {
		lastUpdate.setText(this.getContext().getString(R.string.hy_lastUpdateTime,
				Util.getCurrentTime()));
		state = NONE;
	...
	public void setResultSize(int resultSize) {
		if (resultSize == 0) {
			...
			isLoadFull = true;
			loadFull.setText(R.string.hy_load_full);
	...
	private void refreshHeaderViewByState() {
		...
		case NONE:
			topPadding(-headerContentHeight);
			tip.setText(R.string.hy_pull_to_refresh);
...
//			arrow.setImageResource(R.drawable.pull_to_refresh_arrow);
		...
		case RELEASE:
			...
			refreshing.setVisibility(View.GONE);
			tip.setText(R.string.hy_pull_to_refresh);
			tip.setText(R.string.hy_release_to_refresh);
			arrow.clearAnimation();
