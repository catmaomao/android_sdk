 ...
 * 
 *   @author          张宇 
 *   @create-time     Sep 20, 2011   4:47:30 PM   
 *   @version         $Id
 *
 */
...
/**
 * 该异步任务类是为了防止RejectedExecutionException
 * 
 * @param <Params>
 * @param <Progress>
 * @param <Result>
 */
public abstract class HYAsyncTask<Params, Progress, Result> {
	private static final String LOG_TAG = "HYAsyncTask";

	private static final int CORE_POOL_SIZE = 5;
	private static final int MAXIMUM_POOL_SIZE = 10;
	private static final int KEEP_ALIVE = 10;

	private static final LinkedBlockingQueue<Runnable> sWorkQueue = new LinkedBlockingQueue<Runnable>(5);

	private static final ThreadFactory sThreadFactory = new ThreadFactory() {
		private final AtomicInteger mCount = new AtomicInteger(1);

		public Thread newThread(Runnable r) {
			return new Thread(r, "HYAsyncTask #" + mCount.getAndIncrement());
		}
	};
	...
	public enum Status {
		...
		RUNNING,
		/**
		 * Indicates that {@link HYAsyncTask#onPostExecute} has finished.
		 */
		FINISHED,
	}
			...
			protected void done() {
				...
				try {
					...
					message = sHandler.obtainMessage(MESSAGE_POST_CANCEL,
							new YoukuAsyncTaskResult<Result>(
									HYAsyncTask.this, (Result[]) null));
				...
				message = sHandler.obtainMessage(MESSAGE_POST_RESULT,
						new YoukuAsyncTaskResult<Result>(HYAsyncTask.this,
								result));
				message.sendToTarget();
			}
		};
	 ...
	 *            The parameters of the task.
	 * 
	 * @return This instance of HYAsyncTask.
	 * 
	 * @throws IllegalStateException
	 *             If {@link #getStatus()} returns either
	 *             {@link HYAsyncTask.Status#RUNNING} or
	 *             {@link HYAsyncTask.Status#FINISHED}.
	 */
	public final HYAsyncTask<Params, Progress, Result> execute(
			Params... params) {
	...
	protected final void publishProgress(Progress... values) {
		sHandler.obtainMessage(MESSAGE_POST_PROGRESS,
				new YoukuAsyncTaskResult<Progress>(this, values))
				.sendToTarget();
	}
	...
	private static class InternalHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			YoukuAsyncTaskResult result = (YoukuAsyncTaskResult) msg.obj;
			switch (msg.what) {
	...
	private static class YoukuAsyncTaskResult<Data> {
		@SuppressWarnings({ "rawtypes" })
		final HYAsyncTask mTask;
		final Data[] mData;

		@SuppressWarnings({ "rawtypes" })
		YoukuAsyncTaskResult(HYAsyncTask task, Data... data) {
			mTask = task;
			mData = data;
		}
	}
