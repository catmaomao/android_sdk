...
public class CertificationTipDialog extends Dialog {
	...
	public CertificationTipDialog(Context context, HYCallBack method) {
		super(context);
		this.context = context;
		this.method = method;
	}
	...
	public void show() {
		...
		btn_sure.setText("认证");
		tv_tips.setText(
				"根据国家规定，网络游戏用户需使用有效身份证件进行实名注册，为了给您提供更优质的游戏体验，请您点击‘认证’或在悬浮标内-个人中心处填写您的有效身份证信息，完成认证。未进行实名认证的用户在游戏中将不能正常充值消费。");
