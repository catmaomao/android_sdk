 ...
 *
 */
public class HeyiJoyPush {

	private static HeyiJoyPush instance;
	...
	public static HeyiJoyPush getInstance(){
		
		if(instance == null){
			instance = new HeyiJoyPush();
		}
	...
	private boolean isPluginInited(){
		if(this.pushPlugin == null){
			Log.e("HeyiJoySDK", "The push plugin is not inited or inited failed.");
			return false;
		}
		return true;
	}
