...
public class HeyiJoyHttpUtils {
	...
	public static String httpGet(String urlStr, Map<String, String> params) {
		...
		try {
			...
			Log.d("HeyiJoySDK", "the fullAuthUrl is " + fullUrl);
			url = new URL(fullUrl);
			connection = (HttpURLConnection) url.openConnection();

			Log.d("HeyiJoySDK", "open connection success");
	...
	public static String urlParamsFormat(Map<String, String> params, String charset)
		...
		for (String key : params.keySet()) {
			if (key != null) {
				encodedName = URLEncoder.encode(key, charset);
			} else {
				Log.d("HeyiJoySDK", "encodedName is null");
			}
			if (params.get(key) != null) {
				encodedValue = URLEncoder.encode(params.get(key), charset);
			} else {
				encodedValue = URLEncoder.encode("", charset);
				Log.d("HeyiJoySDK", "encodedValue is null");
			}
			...
			if (sb != null) {
				...
				Log.e("HeyiJoySDK", "StringBuilder is null");
				return "";
			}
		}
