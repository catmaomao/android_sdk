...
import com.heyijoy.sdk.IAnalytics;
import com.heyijoy.sdk.PluginFactory;

/**
 * HeyiJoy 统计分析插件，目前接口适用于 【友盟游戏统计分析插件】
 * @author xiaohei
 *
 */
public class HeyiJoyAnalytics {

	private static HeyiJoyAnalytics instance;
	
	private IAnalytics analyticsPlugin;
	
	private HeyiJoyAnalytics(){
		
	}
	
	public static HeyiJoyAnalytics getInstance(){
		if(instance == null){
			instance = new HeyiJoyAnalytics();
		}
